...
import com.maventech.cryptoapp.databinding.ItemLoadStateBinding

class LoadStateAdapter(
    private val retry: () -> Unit
) : LoadStateAdapter<com.maventech.cryptoapp.ui.adapters.LoadStateAdapter.PassengerLoadStateViewHolder>() {
